...
var l = o((e) => {
  ...
  h = o((e) => {
    ...
    function A(e) {
      0 > k || ((e.current = ue[k]), (ue[k] = null), k--);
    }
    function j(e, t) {
      (k++, (ue[k] = e.current), (e.current = t));
    }
    var fe = de(null),
      pe = de(null),
      me = de(null),
    ...
    function ye(e) {
      (pe.current === e && (A(fe), A(pe)),
        he.current === e && (A(he), (Qf._currentValue = le)));
    }
    var be, xe;
    function Se(e) {
      if (be === void 0)
...
` +
    ...
    var ut = Math.random().toString(36).slice(2),
      ...
      _t = `__reactMarker$` + ut;
    function vt(e) {
      (delete e[dt], delete e[ft], delete e[mt], delete e[ht], delete e[P]);
    }
    function yt(e) {
      var t = e[dt];
      if (t) return t;
    ...
    function xi(e, t) {
      if (typeof e == `object` && e) {
        var n = bi.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: Ee(t) }), bi.set(e, t), t)
          : n;
      }
    ...
    function mc(e, t, n) {
      ...
      if (o !== null) {
        ...
        if ((co(t), a))
          ...
          if (
            ((r = K),
            r !== null && ((s = N(r, n)), s !== 0 && s !== o.retryLane))
          )
    ...
    function Cc(e, t, n) {
      ...
      if (l !== null && ((c = l.dehydrated), c !== null)) {
        if (o)
          ...
          if (
            ((s = K),
            s !== null && ((r = N(s, n)), r !== 0 && r !== l.retryLane))
          )
        ...
        var e = {
            296: (e, t, n) => {
              var r = /^\s+|\s+$/g,
                ...
                s = parseInt,
                c =
                  typeof n.g == `object` && n.g && n.g.Object === Object && n.g,
                l =
                  typeof self == `object` &&
                  self &&
                  self.Object === Object &&
              ...
              return (
                ...
                (i = [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      typeof window > `u` ||
                        ...
                        (C(this.baseComponentRef.current) !==
                          this.scrollElement &&
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this.useIntersectionObserver ||
                        this.setState({ scrollPosition: { x: oe(), y: se() } });
                    },
                  },
                  {
                    key: `render`,
  ...
  re = (e, t) => {
    let n = (0, v.forwardRef)(({ className: n, ...r }, i) =>
      (0, v.createElement)(T, {
        ref: i,
        iconNode: t,
        className: ee(`lucide-${S(w(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
    return ((n.displayName = w(e)), n);
  },
  ie = re(`chevron-right`, [[`path`, { d: `m9 18 6-6-6-6`, key: `mthhwq` }]]),
  ae = re(`x`, [
...
function ue(e) {
  let t = de(e),
    n = v.forwardRef((e, n) => {
      let { children: r, ...i } = e;
      le(r) && typeof D == `function` && (r = D(r._payload));
...
function de(e) {
  let t = v.forwardRef((e, t) => {
    let { children: n, ...r } = e;
    if (
      (le(n) && typeof D == `function` && (n = D(n._payload)),
      v.isValidElement(n))
    ) {
      let e = pe(n),
        i = fe(r, n.props);
      return (
        n.type !== v.Fragment && (i.ref = t ? se(t, e) : e),
        v.cloneElement(n, i)
      );
    }
...
var ye = (e, t) => {
  ...
  Te = (e) => {
    ...
    return {
      getClassGroupId: (e) => {
        ...
        let n = e.split(Se);
        return Ee(n, n[0] === `` && n.length > 1 ? 1 : 0, t);
      },
  ...
  He = (e) => {
    let { prefix: t, experimentalParseClassName: n } = e,
      r = (e) => {
        ...
        s.endsWith(Re)
          ? ((c = s.slice(0, -1)), (l = !0))
          : s.startsWith(Re) && ((c = s.slice(1)), (l = !0));
    ...
    if (t) {
      let e = t + ze,
        n = r;
      r = (t) =>
        t.startsWith(e) ? n(t.slice(e.length)) : Ve(Be, !1, t, void 0, !0);
    }
    if (n) {
      let e = r;
  ...
  nt = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/,
  rt = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,
  it =
    /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,
  at = (e) => $e.test(e),
  N = (e) => !!e && !Number.isNaN(Number(e)),
  ot = (e) => !!e && Number.isInteger(Number(e)),
  st = (e) => e.endsWith(`%`) && N(e.slice(0, -1)),
  ct = (e) => et.test(e),
  lt = () => !0,
  ut = (e) => tt.test(e) && !nt.test(e),
  dt = () => !1,
  ft = (e) => rt.test(e),
  pt = (e) => it.test(e),
  mt = (e) => !P(e) && !F(e),
  ...
  It = Ye(() => {
    let e = M(`color`),
      ...
      w = () => [F, P, c],
      ee = () => [at, `full`, `auto`, ...w()],
      te = () => [ot, `none`, `subgrid`, F, P],
      ne = () => [`auto`, { span: [`full`, ot, F, P] }, ot, F, P],
      T = () => [ot, `auto`, F, P],
      re = () => [`auto`, `min`, `max`, `fr`, F, P],
      ie = () => [
        `start`,
        `end`,
        `center`,
      ...
      E = () => [e, F, P],
      ce = () => [...b(), Ct, vt, { position: [F, P] }],
      D = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      O = () => [`auto`, `cover`, `contain`, wt, ht, { size: [F, P] }],
      le = () => [st, xt, gt],
      ue = () => [``, `none`, `full`, l, F, P],
      k = () => [``, N, xt, gt],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, at, P, F, g] }],
        container: [`container`],
        columns: [{ columns: [N, P, F, s] }],
        ...
        z: [{ z: [ot, `auto`, F, P] }],
        basis: [{ basis: [at, `full`, `auto`, s, ...w()] }],
        "flex-direction": [
          { flex: [`row`, `row-reverse`, `col`, `col-reverse`] },
        ],
        "flex-wrap": [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [N, at, `auto`, `initial`, `none`, P] }],
        grow: [{ grow: [``, N, F, P] }],
        shrink: [{ shrink: [``, N, F, P] }],
        order: [{ order: [ot, `first`, `last`, `none`, F, P] }],
        ...
        "font-size": [{ text: [`base`, n, xt, gt] }],
        "font-smoothing": [`antialiased`, `subpixel-antialiased`],
        "font-style": [`italic`, `not-italic`],
        "font-weight": [{ font: [r, F, _t] }],
        "font-stretch": [
          {
            "font-stretch": [
              `ultra-condensed`,
        ...
        tracking: [{ tracking: [i, F, P] }],
        "line-clamp": [{ "line-clamp": [N, `none`, F, _t] }],
        leading: [{ leading: [a, ...w()] }],
        "list-image": [{ "list-image": [`none`, F, P] }],
        "list-style-position": [{ list: [`inside`, `outside`] }],
        "list-style-type": [{ list: [`disc`, `decimal`, `none`, F, P] }],
        "text-alignment": [
        ...
        "text-decoration-thickness": [
          { decoration: [N, `from-font`, `auto`, F, gt] },
        ],
        "text-decoration-color": [{ decoration: E() }],
        "underline-offset": [{ "underline-offset": [N, `auto`, F, P] }],
        "text-transform": [
          `uppercase`,
          `lowercase`,
          `capitalize`,
        ...
        "border-style": [{ border: [...de(), `hidden`, `none`] }],
        "divide-style": [{ divide: [...de(), `hidden`, `none`] }],
        ...
        "outline-style": [{ outline: [...de(), `none`, `hidden`] }],
        "outline-offset": [{ "outline-offset": [N, F, P] }],
        "outline-w": [{ outline: [``, N, xt, gt] }],
        "outline-color": [{ outline: E() }],
        shadow: [{ shadow: [``, `none`, u, Et, bt] }],
        "shadow-color": [{ shadow: E() }],
        "inset-shadow": [{ "inset-shadow": [`none`, d, Et, bt] }],
        "inset-shadow-color": [{ "inset-shadow": E() }],
        "ring-w": [{ ring: k() }],
        "ring-w-inset": [`ring-inset`],
        "ring-color": [{ ring: E() }],
        "ring-offset-w": [{ "ring-offset": [N, gt] }],
        "ring-offset-color": [{ "ring-offset": E() }],
        "inset-ring-w": [{ "inset-ring": k() }],
        "inset-ring-color": [{ "inset-ring": E() }],
        "text-shadow": [{ "text-shadow": [`none`, f, Et, bt] }],
        "text-shadow-color": [{ "text-shadow": E() }],
        opacity: [{ opacity: [N, F, P] }],
        "mix-blend": [{ "mix-blend": [...A(), `plus-darker`, `plus-lighter`] }],
        "bg-blend": [{ "bg-blend": A() }],
        "mask-clip": [
          {
            "mask-clip": [
        ...
        "mask-image": [{ mask: [`none`, F, P] }],
        filter: [{ filter: [``, `none`, F, P] }],
        blur: [{ blur: fe() }],
        brightness: [{ brightness: [N, F, P] }],
        contrast: [{ contrast: [N, F, P] }],
        "drop-shadow": [{ "drop-shadow": [``, `none`, p, Et, bt] }],
        "drop-shadow-color": [{ "drop-shadow": E() }],
        grayscale: [{ grayscale: [``, N, F, P] }],
        "hue-rotate": [{ "hue-rotate": [N, F, P] }],
        invert: [{ invert: [``, N, F, P] }],
        saturate: [{ saturate: [N, F, P] }],
        sepia: [{ sepia: [``, N, F, P] }],
        "backdrop-filter": [{ "backdrop-filter": [``, `none`, F, P] }],
        "backdrop-blur": [{ "backdrop-blur": fe() }],
        "backdrop-brightness": [{ "backdrop-brightness": [N, F, P] }],
        "backdrop-contrast": [{ "backdrop-contrast": [N, F, P] }],
        "backdrop-grayscale": [{ "backdrop-grayscale": [``, N, F, P] }],
        "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [N, F, P] }],
        "backdrop-invert": [{ "backdrop-invert": [``, N, F, P] }],
        "backdrop-opacity": [{ "backdrop-opacity": [N, F, P] }],
        "backdrop-saturate": [{ "backdrop-saturate": [N, F, P] }],
        "backdrop-sepia": [{ "backdrop-sepia": [``, N, F, P] }],
        ...
        duration: [{ duration: [N, `initial`, F, P] }],
        ease: [{ ease: [`linear`, `initial`, _, F, P] }],
        delay: [{ delay: [N, F, P] }],
        animate: [{ animate: [`none`, v, F, P] }],
        backface: [{ backface: [`hidden`, `visible`] }],
        perspective: [{ perspective: [h, F, P] }],
        ...
        "skew-x": [{ "skew-x": he() }],
        "skew-y": [{ "skew-y": he() }],
        transform: [{ transform: [F, P, ``, `none`, `gpu`, `cpu`] }],
...
function zt({ className: e, variant: t, size: n, asChild: r = !1, ...i }) {
  return (0, b.jsx)(r ? k : `button`, {
    "data-slot": `button`,
    className: Lt(Rt({ variant: t, size: n, className: e })),
    ...i,
  });
}
...
function Vt(e, t) {
  let n = v.createContext(t),
    r = (e) => {
      let { children: t, ...r } = e,
        i = v.useMemo(() => r, Object.values(r));
...
var Jt = v.useInsertionEffect || Wt;
function Yt({ prop: e, defaultProp: t, onChange: n = () => {}, caller: r }) {
  let [i, a, o] = Xt({ defaultProp: t, onChange: n }),
    s = e !== void 0,
    c = s ? e : i;
  {
  ...
  gn = v.forwardRef((e, t) => {
    ...
    return (
      ...
      v.useEffect(() => {
        let e = () => p({});
        return (
          document.addEventListener(dn, e),
          () => document.removeEventListener(dn, e)
        );
      }, []),
      (0, b.jsx)(on.div, {
        ...c,
        ...
        onFocusCapture: Bt(e.onFocusCapture, w.onFocusCapture),
  ...
  return (
    v.useEffect(() => {
      let e = (e) => {
        e.target &&
          !r.current &&
          Sn(pn, n, { originalEvent: e }, { discrete: !1 });
      };
      return (
    ...
    (v.useEffect(() => {
      if (r) {
        let e = function (e) {
            ...
            let t = e.target;
            s.contains(t) ? (d.current = t) : Pn(d.current, { select: !0 });
          },
          t = function (e) {
            if (p.paused || !s) return;
            let t = e.relatedTarget;
            t !== null && (s.contains(t) || Pn(d.current, { select: !0 }));
          },
          n = function (e) {
            if (document.activeElement === document.body)
              for (let t of e) t.removedNodes.length > 0 && Pn(s);
          };
      ...
      v.useEffect(() => {
        if (s) {
          ...
          if (!s.contains(e)) {
            ...
            (s.addEventListener(Cn, l),
              s.dispatchEvent(t),
              t.defaultPrevented ||
                (On(Rn(An(s)), { select: !0 }),
                document.activeElement === e && Pn(s)));
          }
          return () => {
            (s.removeEventListener(Cn, l),
              setTimeout(() => {
                let t = new CustomEvent(wn, Tn);
                (s.addEventListener(wn, u),
                  s.dispatchEvent(t),
                  t.defaultPrevented || Pn(e ?? document.body, { select: !0 }),
                  s.removeEventListener(wn, u),
                  Fn.remove(p));
              }, 0));
          };
        }
    ...
    let m = v.useCallback(
      (e) => {
        ...
        if (t && i) {
          ...
          r && a
            ? !e.shiftKey && i === a
              ? (e.preventDefault(), n && Pn(r, { select: !0 }))
              : e.shiftKey &&
                i === r &&
                (e.preventDefault(), n && Pn(a, { select: !0 }))
            : i === t && e.preventDefault();
        }
      },
      [n, r, p.paused],
    );
    return (0, b.jsx)(on.div, { tabIndex: -1, ...o, ref: f, onKeyDown: m });
  });
Dn.displayName = En;
...
var zn = c(m(), 1),
  ...
  Vn = v.forwardRef((e, t) => {
    ...
    return o ? zn.createPortal((0, b.jsx)(on.div, { ...r, ref: t }), o) : null;
  });
Vn.displayName = Bn;
function Hn(e, t) {
...
function Jn() {
  v.useEffect(() => {
    ...
    return (
      document.body.insertAdjacentElement(`afterbegin`, e[0] ?? Yn()),
      document.body.insertAdjacentElement(`beforeend`, e[1] ?? Yn()),
      qn++,
      () => {
        (qn === 1 &&
          document
...
var $n = `right-scroll-bar-position`,
  er = `width-before-scroll-bar`,
  tr = `with-scroll-bars-hidden`,
...
var ar = typeof window < `u` ? v.useLayoutEffect : v.useEffect,
  or = new WeakMap();
function sr(e, t) {
...
var pr = ur(),
  ...
  hr = v.forwardRef(function (e, t) {
    ...
    return v.createElement(
      ...
      o
        ? v.cloneElement(v.Children.only(s), Xn(Xn({}, w), { ref: C }))
        : v.createElement(y, Xn({}, w, { className: c, ref: C }), s),
    );
  });
((hr.defaultProps = { enabled: !0, removeScrollBar: !0, inert: !1 }),
  (hr.classNames = { fullWidth: er, zeroRight: $n }));
var gr,
  _r = function () {
    if (gr) return gr;
...
`
  ...
  Mr = function () {
    v.useEffect(function () {
      return (
        document.body.setAttribute(kr, (jr() + 1).toString()),
        function () {
          var e = jr() - 1;
          e <= 0
  ...
  Nr = function (e) {
    ...
    return v.createElement(Or, { styles: Ar(a, !t, i, n ? `` : `!important`) });
  },
  Pr = !1;
if (typeof window < `u`)
  try {
...
var Ir = Pr ? { passive: !1 } : !1,
  ...
  Rr = function (e, t) {
    ...
    return (
      n[t] !== `hidden` &&
      !(n.overflowY === n.overflowX && !Lr(e) && n[t] === `visible`)
    );
  },
  zr = function (e) {
  ...
  qr = function (e, t, n, r, i) {
    var a = Kr(e, window.getComputedStyle(t).direction),
      o = a * r,
      s = n.target,
      c = t.contains(s),
      l = !1,
...
function ti(e) {
    ...
    v.useEffect(
      function () {
        if (e.inert) {
          ...
          var t = Qn([e.lockRef.current], (e.shards || []).map(Xr), !0).filter(
            Boolean,
          );
          return (
  ...
  var s = v.useCallback(function (e, t) {
    ...
    l = v.useCallback(function (e, n, r, i) {
      var a = { name: e, delta: n, target: r, should: i, shadowParent: ni(r) };
      (t.current.push(a),
        setTimeout(function () {
  ...
  v.useEffect(function () {
    return (
      ...
      document.addEventListener(`wheel`, c, Ir),
      document.addEventListener(`touchmove`, c, Ir),
      document.addEventListener(`touchstart`, u, Ir),
      function () {
        ((ei = ei.filter(function (e) {
          return e !== a;
        })),
          document.removeEventListener(`wheel`, c, Ir),
          document.removeEventListener(`touchmove`, c, Ir),
          document.removeEventListener(`touchstart`, u, Ir));
      }
    );
  }, []);
  ...
  return v.createElement(
    v.Fragment,
    null,
    m ? v.createElement(a, { styles: Qr(i) }) : null,
    p
      ? v.createElement(Nr, { noRelative: e.noRelative, gapMode: e.gapMode })
      : null,
  );
}
function ni(e) {
...
var ri = fr(pr, ti),
  ii = v.forwardRef(function (e, t) {
    return v.createElement(hr, Xn({}, e, { ref: t, sideCar: ri }));
  });
ii.classNames = hr.classNames;
var ai = ii,
  oi = function (e) {
    ...
    return (
      ...
      function () {
        (o.forEach(function (e) {
          ...
          (si.set(e, t),
            a.set(e, i),
            t || (ci.has(e) || e.removeAttribute(r), ci.delete(e)),
...
var xi = `Dialog`,
  ...
  Ei = (e) => {
    let {
      ...
      s = v.useRef(null),
      c = v.useRef(null),
      [l, u] = Yt({ prop: r, defaultProp: i ?? !1, onChange: a, caller: xi });
    return (0, b.jsx)(wi, {
      scope: t,
      triggerRef: s,
      contentRef: c,
...
Ei.displayName = xi;
var Di = `DialogTrigger`,
  Oi = v.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = Ti(Di, n),
      a = E(t, i.triggerRef);
    return (0, b.jsx)(on.button, {
      type: `button`,
      ...
      ...r,
      ref: a,
      onClick: Bt(e.onClick, i.onOpenToggle),
    });
  });
Oi.displayName = Di;
var ki = `DialogPortal`,
  [Ai, ji] = Si(ki, { forceMount: void 0 }),
  Mi = (e) => {
    ...
    return (0, b.jsx)(Ai, {
      ...
      children: v.Children.map(r, (e) =>
        (0, b.jsx)(Un, {
          present: n || a.open,
          children: (0, b.jsx)(Vn, { asChild: !0, container: i, children: e }),
        }),
      ),
    });
  };
...
var Ni = `DialogOverlay`,
  Pi = v.forwardRef((e, t) => {
    let n = ji(Ni, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...i } = e,
      a = Ti(Ni, e.__scopeDialog);
    return a.modal
      ? (0, b.jsx)(Un, {
          present: r || a.open,
          children: (0, b.jsx)(Ii, { ...i, ref: t }),
        })
      : null;
  });
Pi.displayName = Ni;
var Fi = hi(`DialogOverlay.RemoveScroll`),
  Ii = v.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = Ti(Ni, n);
    return (0, b.jsx)(ai, {
  ...
  I = `DialogContent`,
  L = v.forwardRef((e, t) => {
    let n = ji(I, e.__scopeDialog),
      { forceMount: r = n.forceMount, ...i } = e,
      a = Ti(I, e.__scopeDialog);
    return (0, b.jsx)(Un, {
      present: r || a.open,
      children: a.modal
        ? (0, b.jsx)(Li, { ...i, ref: t })
...
L.displayName = I;
var Li = v.forwardRef((e, t) => {
    let n = Ti(I, e.__scopeDialog),
      r = v.useRef(null),
    ...
    return (
      ...
      (0, b.jsx)(zi, {
        ...
        onCloseAutoFocus: Bt(e.onCloseAutoFocus, (e) => {
          (e.preventDefault(), n.triggerRef.current?.focus());
        }),
        onPointerDownOutside: Bt(e.onPointerDownOutside, (e) => {
          let t = e.detail.originalEvent,
            n = t.button === 0 && t.ctrlKey === !0;
          (t.button === 2 || n) && e.preventDefault();
        }),
        onFocusOutside: Bt(e.onFocusOutside, (e) => e.preventDefault()),
      })
    );
  }),
  Ri = v.forwardRef((e, t) => {
    ...
    return (
      ...
      (0, b.jsxs)(b.Fragment, {
        children: [
          ...
          (0, b.jsxs)(b.Fragment, {
            children: [
              (0, b.jsx)(Xi, { titleId: s.titleId }),
              (0, b.jsx)(Qi, { contentRef: c, descriptionId: s.descriptionId }),
            ],
          }),
        ],
      })
  ...
  Vi = v.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = Ti(Bi, n);
    return (0, b.jsx)(on.h2, { id: i.titleId, ...r, ref: t });
  });
Vi.displayName = Bi;
var Hi = `DialogDescription`,
  Ui = v.forwardRef((e, t) => {
    let { __scopeDialog: n, ...r } = e,
      i = Ti(Hi, n);
    return (0, b.jsx)(on.p, { id: i.descriptionId, ...r, ref: t });
  });
Ui.displayName = Hi;
var Wi = `DialogClose`,
  Gi = v.forwardRef((e, t) => {
    ...
    return (0, b.jsx)(on.button, {
      ...
      ...r,
      ref: t,
      onClick: Bt(e.onClick, () => i.onOpenChange(!1)),
    });
  });
Gi.displayName = Wi;
function Ki(e) {
...
var qi = `DialogTitleWarning`,
  [Ji, Yi] = Vt(qi, { contentName: I, titleName: Bi, docsSlug: `dialog` }),
  Xi = ({ titleId: e }) => {
    let t = Yi(qi),
...
For more information, see https://radix-ui.com/primitives/docs/components/${t.docsSlug}`;
  ...
  Zi = `DialogDescriptionWarning`,
  Qi = ({ contentRef: e, descriptionId: t }) => {
    let n = `Warning: Missing \`Description\` or \`aria-describedby={undefined}\` for {${Yi(Zi).contentName}}.`;
    return (
      v.useEffect(() => {
  ...
  aa = Gi;
function oa({ ...e }) {
  return (0, b.jsx)($i, { "data-slot": `dialog`, ...e });
}
function sa({ ...e }) {
  return (0, b.jsx)(ea, { "data-slot": `dialog-trigger`, ...e });
}
function ca({ ...e }) {
  return (0, b.jsx)(ta, { "data-slot": `dialog-portal`, ...e });
}
function la({ ...e }) {
  return (0, b.jsx)(aa, { "data-slot": `dialog-close`, ...e });
}
...
function da({ className: e, children: t, showCloseButton: n = !0, ...r }) {
  return (0, b.jsxs)(ca, {
...
var Ma = ja,
  Na = `[object Symbol]`;
function Pa(e) {
  return typeof e == `symbol` || (Ma(e) && Aa(e) == Na);
}
var Fa = Pa,
  Ia = Array.isArray,
  La = /\s/;
...
var za = Ra,
  Ba = /^\s+/;
function Va(e) {
  return e && e.slice(0, za(e) + 1).replace(Ba, ``);
}
var Ha = Va;
function Ua(e) {
  var t = typeof e;
...
function Xa(e) {
  ...
  e = Ha(e);
  var n = qa.test(e);
  return n || Ja.test(e) ? Ya(e.slice(2), n ? 2 : 8) : Ka.test(e) ? Ga : +e;
}
var Za = Xa,
  Qa = 1 / 0,
...
function oo(e) {
  if (!Wa(e)) return !1;
  var t = Aa(e);
  return t == ro || t == io || t == no || t == ao;
}
var so = oo,
  co = ha[`__core-js_shared__`],
  lo = (function () {
...
function bo(e) {
  return !Wa(e) || fo(e) ? !1 : (so(e) ? yo : B).test(mo(e));
}
var xo = bo;
function So(e, t) {
  return e?.[t];
...
var Po = No;
function Fo(e) {
  return e != null && Po(e.length) && !so(e);
}
var Io = Fo;
function Lo(e, t, n) {
  if (!Wa(n)) return !1;
  var r = typeof t;
  return (r == `number` ? Io(n) && ko(t, n.length) : r == `string` && t in n)
    ? jo(n[t], e)
    : !1;
}
var Ro = Lo,
...
var Wo = Uo,
  ...
  Jo = Wo(
    ...
    ? Wo
    : function (e) {
        return Ma(e) && Ko.call(e, `callee`) && !qo.call(e, `callee`);
      };
function Yo() {
  return !1;
}
var Xo = Yo,
  Zo = typeof exports == `object` && exports && !exports.nodeType && exports,
  Qo = Zo && typeof module == `object` && module && !module.nodeType && module,
  $o = Qo && Qo.exports === Zo ? ha.Buffer : void 0,
  es = ($o ? $o.isBuffer : void 0) || Xo,
  ts = `[object Arguments]`,
  ns = `[object Array]`,
  rs = `[object Boolean]`,
  is = `[object Date]`,
  ...
  H = {};
((H[gs] = H[_s] = H[vs] = H[ys] = H[bs] = H[xs] = H[Ss] = H[Cs] = H[ws] = !0),
  (H[ts] =
    H[ns] =
    H[ms] =
    H[rs] =
    ...
    H[ps] =
      !1));
function Ts(e) {
  return Ma(e) && Po(e.length) && !!H[Aa(e)];
}
var Es = Ts;
function Ds(e) {
  return function (t) {
...
var Os = Ds,
  ks = typeof exports == `object` && exports && !exports.nodeType && exports,
  As = ks && typeof module == `object` && module && !module.nodeType && module,
  js = As && As.exports === ks && pa.process,
  Ms = (function () {
    try {
      return (
        (As && As.require && As.require(`util`).types) ||
        (js && js.binding && js.binding(`util`))
      );
    } catch {}
  })(),
  Ns = Ms && Ms.isTypedArray,
  Ps = Ns ? Os(Ns) : Es;
function Fs(e, t) {
  return function (n) {
    return e(t(n));
...
var Is = Fs(Object.keys, Object),
  Ls = Object.prototype.hasOwnProperty;
function Rs(e) {
  if (!Vo(e)) return Is(e);
  var t = [];
  for (var n in Object(e)) Ls.call(e, n) && n != `constructor` && t.push(n);
  return t;
}
var zs = Rs,
  Bs = wo(ha, `Map`),
  ...
  ec = mo(To),
  tc = Aa;
((Vs && tc(new Vs(new ArrayBuffer(1))) != Ys) ||
  (Bs && tc(new Bs()) != Ws) ||
  (Hs && tc(Hs.resolve()) != Ks) ||
  (Us && tc(new Us()) != qs) ||
  (To && tc(new To()) != Js)) &&
...
function oc(e) {
  ...
  if (
    ...
    return !e.length;
  var t = nc(e);
  if (t == rc || t == ic) return !e.size;
  if (Vo(e)) return !zs(e).length;
...
function hc(e, t, n) {
  if (
    (n && typeof n != `boolean` && Ro(e, t, n) && (t = n = void 0),
    n === void 0 &&
      (typeof t == `boolean`
        ? ((n = t), (t = void 0))
    ...
    e === void 0 && t === void 0
      ? ((e = 0), (t = 1))
      : ((e = to(e)), t === void 0 ? ((t = e), (e = 0)) : (t = to(t))),
    e > t)
  ) {
    var r = e;
    ((e = t), (t = r));
  ...
  if (n || e % 1 || t % 1) {
    var i = mc();
    return pc(e + i * (t - e + fc(`1e-` + ((i + ``).length - 1))), t);
  }
  return dc(e, t);
}
var gc = hc;
function _c({ className: e, ...t }) {
  return (0, b.jsx)(`div`, {
    "data-slot": `skeleton`,
    className: Lt(`relative overflow-hidden rounded-md bg-zinc-200`, e),
    ...t,
    children: (0, b.jsx)(`div`, {
      className: `absolute inset-0 animate-[shimmer_1s_linear_infinite]`,
      style: {
        background: `linear-gradient(125deg, transparent 0%, transparent 33%, rgba(255,255,255,0.4) 50%, transparent 67%, transparent 100%)`,
...
var vc = [];
for (let e = 0; e < 256; ++e) vc.push((e + 256).toString(16).slice(1));
function yc(e, t = 0) {
  return (
    vc[e[t + 0]] +
    vc[e[t + 1]] +
...
function Sc() {
  if (!bc) {
    ...
    bc = crypto.getRandomValues.bind(crypto);
  }
  return bc(xc);
}
var Cc = {
...
function Tc(e, t, n) {
  return Cc.randomUUID && !t && !e ? Cc.randomUUID() : wc(e, t, n);
}
var Ec = Tc;
const Dc = [
    `ArionPlay`,
...
((window.client_id = Ac(`client_id`)),
  (window.session_id = Ac(`session_id`)));
const jc = ({ gameInfo: e, isFirstScreen: t = !1, index: n }) => {
  let [r, i] = (0, v.useState)(!0),
    [a, o] = (0, v.useState)(!0);
  Oc(e.name);
  let s = gc(300, 500);
  return (
      ...
      onClick: () => {
        r ||
          setTimeout(() => {
            location.href =
              e.url +
              `?client_id=${window.client_id}&session_id=${window.session_id}`;
          }, 300);
      },
      children: [
        (0, b.jsxs)(`div`, {
          className: Lt(
            `h-20 w-20 overflow-hidden rounded-[20px]`,
            `shadow-[0px_4px_20px_0px_rgba(0,0,0,0.12)]`,
          ),
          children: [
            r && (0, b.jsx)(_c, { className: `h-full w-full` }),
            (0, b.jsx)(x, {
              className: Lt(
                `hidden h-full w-full rounded-[20px] bg-white`,
                !r && `block`,
              ),
              width: 80,
              height: 80,
        ...
        (0, b.jsxs)(`div`, {
          className: Lt(
            `relative h-6 w-20 truncate pt-2 text-xs font-bold text-zinc-800 underline`,
          ),
          children: [
            a && (0, b.jsx)(_c, { className: `h-full w-full` }),
            !a && e.name,
          ],
        }),
      ],
...
var Mc = (() => {
    let e = Array.isArray(window.gameList) ? window.gameList.slice() : [];
    try {
      let t = (n) => {
        ...
        n = !1;
      try {
        let r = `6dCQiFihAdfxSfBfdfd2w_do`;
  ...
  Nc = () => {
    ...
    return (
      (0, v.useEffect)(() => {
        let e = () => {
          let e = window.innerWidth < 768,
            n = Math.min(window.innerWidth, 1100) - 40,
            i = e ? 40 : 80,
            a = Math.floor((n + i) / (80 + i));
          t(a * 80 + (a - 1) * i);
          let o = Math.min(window.innerWidth, 600) - 20 - 40,
            s = Math.min(Math.floor((o + 32) / 112), 4);
          r(s * 80 + (s - 1) * 32);
        };
        return (
          e(),
      ...
      (0, b.jsxs)(`div`, {
        className: `flex max-w-[648px] flex-1 flex-wrap justify-center px-[10px] pb-12 md:px-0`,
        children: [
          (0, b.jsx)(`div`, {
            className: `size w-full p-1 text-center text-[0px]`,
            children: (0, b.jsx)(x, {
              width: 112,
              height: 112,
          ...
          (0, b.jsx)(`div`, {
            className: `flex w-full justify-center pt-2 pb-[20px] text-center`,
            children: (0, b.jsx)(`img`, {
              alt: `access restricted`,
              className: `w-[250px] md:w-[270px]`,
              src: `./media/title.png`,
            }),
          }),
          (0, b.jsxs)(`p`, {
            className: `w-full px-[8px] pb-[14px] text-center text-sm text-black md:px-0`,
            children: [
              `This website is`,
              (0, b.jsx)(`b`, {
                children: ` not licensed by Philippine authorities`,
              }),
              `. Many users have reported`,
              (0, b.jsx)(`b`, {
                children: ` scams, fake games, and lost money`,
              }),
              ` that could not be recovered.`,
            ],
          }),
          (0, b.jsxs)(`p`, {
            className: `px-[20px] text-center text-sm text-black md:px-[14px]`,
            children: [
              `Unlicensed gambling sites offer `,
              (0, b.jsx)(`b`, { children: `no government protection` }),
              `. Any money you lose `,
              (0, b.jsx)(`b`, { children: `cannot be returned` }),
              `, and your personal data may be at risk.`,
            ],
          }),
          (0, b.jsx)(`section`, {
            className: `flex w-full items-center justify-center py-4 px-3`,
            children: (0, b.jsx)(`img`, {
              className: `w-full max-w-[400px]`,
              src: `./media/pagcor-group.png`,
            }),
          }),
          (0, b.jsxs)(`div`, {
            ...
            children: [
              (0, b.jsxs)(`div`, {
                children: [
                  (0, b.jsxs)(`p`, {
                    className: `px-3 pb-[18px] text-center text-sm text-black md:px-14`,
                    children: [
                      `For your safety, please use the `,
                      (0, b.jsx)(`b`, {
                        children: `PAGCOR-approved websites `,
                      }),
                      `listed below.`,
                    ],
                  }),
                  (0, b.jsxs)(`div`, {
                    className: `mb-[24px] flex flex-col items-center rounded-xl bg-white px-[20px] py-[30px] md:px-[60px]`,
                    children: [
                      (0, b.jsx)(`div`, {
                        style: { width: n },
                        className: `flex flex-wrap gap-x-8 gap-y-6 text-center`,
                        children: Mc.slice(0, 12).map((e, t) =>
                          (0, b.jsx)(
                            jc,
                            { isFirstScreen: !0, gameInfo: e, index: t },
                            `game-list-${t}`,
                          ),
                        ),
                      }),
                      (0, b.jsxs)(oa, {
                        children: [
                          (0, b.jsx)(sa, {
                            asChild: !0,
                            children: (0, b.jsxs)(zt, {
                              variant: `outline`,
                              className: `mt-[34px] flex h-[34px] w-[100px] items-center justify-center gap-1 rounded-lg text-blue-700 outline -outline-offset-1 outline-neutral-200`,
                          ...
                          (0, b.jsxs)(da, {
                            showCloseButton: !1,
                            className: `h-full w-full max-w-none! justify-center overflow-y-scroll p-[20px]`,
                            children: [
                              (0, b.jsx)(la, {
                                className: `absolute top-2 right-5 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 p-1 text-center`,
                                "aria-label": `Close`,
                                children: (0, b.jsx)(ae, { size: `24` }),
                              }),
                              (0, b.jsxs)(`div`, {
                                className: `max-w-[1100px]`,
                                children: [
                                  (0, b.jsx)(`h4`, {
                                    className: `justify-start text-lg font-bold text-zinc-800 md:text-center`,
                                    children: `PAGCOR-approved Websites`,
                                  }),
                                  (0, b.jsx)(`div`, {
                                    ...
                                    children: (0, b.jsx)(`div`, {
                                      style: { width: e },
                                      className: `flex flex-wrap gap-x-10 gap-y-[30px] py-[30px] text-[0px] md:gap-x-20 md:gap-y-10`,
                                      children: Mc.map((e, t) =>
                                        (0, b.jsx)(
                                          jc,
                                          { gameInfo: e, index: t },
              ...
              (0, b.jsx)(`p`, {
                className: `w-full justify-start px-17 text-center text-xs text-stone-500`,
                children: `© 2026 Cybercrime Investigation and Coordinating Center (CICC)`,
              }),
            ],
          }),
        ],
...
(0, g.createRoot)(document.getElementById(`app`)).render((0, b.jsx)(Pc, {}));
